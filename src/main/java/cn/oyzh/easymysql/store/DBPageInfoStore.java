...
// * @since 2023/01/17
// */
//public class DBPageInfoStore extends ObjectFileStore<MysqlPageInfo> {
//
//    /**
//     * 当前实例
//     */
...
//     * 当前设置
//     */
//    public static final MysqlPageInfo PAGE_INFO = INSTANCE.load();
//
//    {
...
//
//    @Override
//    public synchronized MysqlPageInfo load() {
//        MysqlPageInfo pageInfo = null;
//        try {
//            // 从文件中读取文本内容
//            String text = FileUtil.readString(this.storeFile(), this.charset());
//            if (StrUtil.isNotBlank(text)) {
//                // 将文本内容转换为页面信息对象
//                pageInfo = JSONUtil.toBean(text, MysqlPageInfo.class);
//            }
//        } catch (Exception ex) {
//            ex.printStackTrace();
//        }
